...
namespace SaleWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bobbrown@email.com", 1000.0, new DateTime(1998, 4, 21), d1);
            Seller s2 = new Seller(2, "Bill Blue", "billblue@email.com", 1200.0, new DateTime(1993, 1, 12), d2);
            Seller s3 = new Seller(3, "Yennifer Yellow", "yenyellow@email.com", 1500.0, new DateTime(2000, 6, 6), d3);
            Seller s4 = new Seller(4, "Regis Red", "regisred@email.com", 1800.0, new DateTime(1992, 1, 13), d4);
            Seller s5 = new Seller(5, "Geralt Green", "geraltgreen@email.com",2100.0, new DateTime(1988, 4, 21), d3);
            Seller s6 = new Seller(6, "Well White", "wellwhite@email.com", 1000.0, new DateTime(1995, 4, 21), d4);
